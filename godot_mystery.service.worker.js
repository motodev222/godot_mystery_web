...
/** @type {string} */
const CACHE_VERSION = '1744640072|113273811197';
/** @type {string} */
const CACHE_PREFIX = 'godot_mystery-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'godot_mystery.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["godot_mystery.html","godot_mystery.js","godot_mystery.offline.html","godot_mystery.icon.png","godot_mystery.apple-touch-icon.png","godot_mystery.audio.worklet.js","godot_mystery.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["godot_mystery.wasm","godot_mystery.pck"];
